  ...
  return (
    <div className={`app-container ${theme}`}>
      <style>{`
        ...
        .tab-btn { padding: 10px 18px; border: 1px solid var(--border); border-radius: 12px; background: var(--input-bg); color: var(--muted); cursor: pointer; font-size: 13px; font-weight: 600; margin-bottom: 8px; white-space: nowrap; flex: 1; text-align: center; transition: 0.2s; }
      ...
      {/* --- SIDEBAR (Floating Glass Bar on Mobile) --- */}
      ...
      <div className="main-content">
        <div className="mobile-header">
            <h1 style={{fontSize: "18px", fontWeight: "900", marginLeft: "10px"}}>PAJJI <span style={{color: "#10b981"}}>LEARN</span></h1>
            <div style={{display: "flex", gap: "12px", alignItems: "center", marginRight: "10px"}}>
                <div style={{fontSize: "12px", fontWeight: "bold", background: "var(--accent)", color: "white", padding: "4px 10px", borderRadius: "20px"}}>{userXP} XP</div>
          ...
          <div style={{maxWidth: "900px"}}>
            ...
            <div className="dashboard-grid" style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px", marginBottom: "40px"}}>
              <div className="card" style={{borderLeft: "4px solid #10b981"}}>
                  ...
                  <h3 style={{fontSize: "32px", color: "#10b981", marginTop: "8px"}}>{userXP} <span style={{fontSize: "16px", opacity: 0.5}}>XP</span></h3>
              </div>
